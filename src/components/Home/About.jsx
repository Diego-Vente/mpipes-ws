        ...
        <Row>
          <Col md={8} className="home-about-description">
            <h1 style={{ fontSize: "2.6em" }}>
              SEAMOS <span className="about-hl"> SINCEROS </span>
            </h1>
            <p className="home-about-body1">Necesitas una <strong className="main-name">página web</strong> cuando quieres dominar tu presencia online.</p>
            <p className="home-about-body1">Necesitas <strong className="main-name">automatización</strong> cuando buscas eficiencia máxima y productividad imparable.</p>
            <p className="home-about-body1">Necesitas <strong className="main-name">delivery</strong> cuando deseas llegar a tus clientes de forma instantánea.</p>
            <p className="home-about-body1">Necesitas <strong className="main-name">chatbots</strong> cuando exiges atención al cliente 24/7 sin descanso.</p>
            <p className="home-about-body1">Necesitas <strong className="main-name">programas</strong> cuando anhelas soluciones personalizadas para tus desafíos comerciales.</p>
